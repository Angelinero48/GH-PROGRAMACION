...
public class Ejercicio27 {
  public static void main(String[] args) {
    ...
    System.out.print("¿Quiere nata? (responde con si o no): ");
    boolean conNata = (s.next().toLowerCase()).equals("si");
    System.out.print("¿Quiere ponerle un nombre? (responde con si o no): ");
    boolean conNombre = (s.nextLine().toLowerCase()).equals("si");
